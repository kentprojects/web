...
<script>
	...
	API.GET(
		...
		function (data) {
			document.querySelector(".MyProject ul").innerHTML = scrollerHTML(data.body, "project");
		},
		function (data) {
			console.error(data);
		}
	...
	API.GET(
		...
		function (data) {
			console.log(data);
			document.querySelector(".MySupervisor ul").innerHTML = scrollerHTML(data.body, "staff");
		},
		function (data) {
			console.error(data);
		}
