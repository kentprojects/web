...
<div class="container">
	<div class="row Header">
		<div class="col-sm-3 col-xs-12">
			<div class="dropdown dashboardSelector">
				...
				<ul class="dropdown-menu dashboardSelector" id="roleSelectorDropdown" role="menu" aria-labelledby="dropdownMenu1">
		...
		<div class="col-sm-3 col-xs-12">
			<div class="dashboardSelector">
				<form action="dashboard.php" method="get">
					<input type="text" name="year" id="yearSelector" class="form-control text-center" placeholder="">
				</form>
			</div>
		</div>
	</div>
